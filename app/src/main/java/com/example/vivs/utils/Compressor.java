...
public class Compressor {
    ...
    public File compressToFile(String imageFile,File file, String compressedFileName) throws IOException {
        return ImageUtil.compressImage(imageFile,file, maxWidth, maxHeight, compressFormat, quality,
                destinationDirectoryPath + File.pathSeparator + compressedFileName);
    }


    public File compressToFile(String imageFile) throws IOException {
        File file = new File(imageFile);
        return compressToFile(imageFile,file, file.getName());
    }
